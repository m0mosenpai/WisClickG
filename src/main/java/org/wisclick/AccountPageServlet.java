	 ...
	 * Otherwise, the viewer can only view the page without editing. 
		...
		if(session == null){
			...
			content.println("<title>Account Page</title>");
    			content.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"./css/AccountPage.css\">");
			...
			content.print("<img src=\"./images/color-flush-reverse-UWlogo-print.png\" width=\"270\" height=\"90\" class=\"d-inline-block align-top\" alt=\"\">");
			...
			// Define the js file, and close tags for this page
 			content.println("<script type=\"text/javascript\" src=\"./js/Account.js\"></script>");
			content.println("</body>");
			content.println("</html>");
