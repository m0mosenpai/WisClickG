...
public class TransferPageServlet extends HttpServlet {
	...
	/*
         ...
         * Display the transfer result if it can be retrieved from the response.
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse res) throws IOException {
		...
		if(session == null){
			...
			content.println("<title>Transfer Page</title>");
                	content.println("<link rel=\"stylesheet\" type=\"text/css\" href=\"./css/Transfer.css\">");
			...
			content.println("<div id=\"headerNav\">");
                	content.println("<img src=\"./images/color-flush-reverse-UWlogo-print.png\" width=\"270\" height=\"90\" class=\"d-inline-block align-top\">");
