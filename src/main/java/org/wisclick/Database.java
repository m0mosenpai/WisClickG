...
public class Database {
	...
	public static int getPoints(String username) {
		...
		if(cursorName == null){
			...
			Integer num = cursorName.getInteger("points"); //test
	...
	public static int transferPoints(String from, String to, int addPoints){
		...
		try {
			...
			Integer fromCurPoints = collection.find(eq("username", from)).first().getInteger("points"); //test
			...
			Integer toCurPoints = collection.find(eq("username", to)).first().getInteger("points"); // test
	...
	public static ArrayList<String[]> getRankList(){
		...
		for(Document document: documents) {
			...
			int curPoints = (int)Math.round(document.getInteger("points")); //test
